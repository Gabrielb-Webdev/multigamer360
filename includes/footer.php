...
<?php
// Incluir sistema de versiones de assets
if (file_exists(__DIR__ . '/../config/asset_versions.php')) {
    require_once __DIR__ . '/../config/asset_versions.php';
}
?>
    <!-- Footer -->
    ...
    <script>
        console.log('Assets cargados - Main.js v<?php echo defined('JS_VERSION') ? JS_VERSION['main'] : '1.1'; ?>');
    </script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(data => {
                ...
                if (cartDisplay && data.cart_total !== undefined) {
                    ...
                    console.log('Footer sync - Updated display to:', formattedText);
                }
            })
            .catch(error => {
