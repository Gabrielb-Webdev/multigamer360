...
try {
    ...
    if ($isLoggedIn && isset($pdo)) {
        // Usar la misma lógica que en wishlist.php y ajax/get-wishlist-count.php
...
if ($cartCount > 0) {
    $cartDisplayText = $cartCount . ' - $' . number_format($cartTotal, 2);
} else {
    $cartDisplayText = '$0';
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/cart-button-modern.css?v=5.3">
    ...
    <script>
        ...
        function updateCartDisplay(data) {
            ...
            if (cartDisplay && data.cart_total !== undefined) {
                ...
                cartDisplay.textContent = formattedText;
            }
    ...
    <script src="assets/js/cart-stock-validator.js?v=2.7"></script>
    
    <!-- Sistema de cambio de moneda -->
    <script>
        // Obtener moneda guardada o usar ARS por defecto
        ...
        function updateCurrencyDisplay() {
            const arsOption = document.getElementById('ars-option');
            const usdOption = document.getElementById('usd-option');
            
            if (arsOption && usdOption) {
                if (currentCurrency === 'ARS') {
                    arsOption.style.color = '#dc3545'; // Rojo
                    arsOption.style.fontWeight = 'bold';
                    usdOption.style.color = '#fff';
                    usdOption.style.fontWeight = 'normal';
                } else {
                    arsOption.style.color = '#fff';
                    arsOption.style.fontWeight = 'normal';
                    usdOption.style.color = '#dc3545'; // Rojo
                    usdOption.style.fontWeight = 'bold';
                }
            }
        }
        
        // Cambiar todos los precios según la moneda seleccionada
            ...
            document.querySelectorAll('[data-price-ars][data-price-usd]').forEach(element => {
                ...
                if (currentCurrency === 'USD') {
                    ...
                    if (!isNaN(priceARS) && priceARS > 0) {
                        element.textContent = '$' + priceARS.toLocaleString('es-AR', {minimumFractionDigits: 0, maximumFractionDigits: 0});
                    } else {
                    ...
                    <div class="container-fluid px-4 h-100">
                        <div class="d-flex justify-content-between align-items-center h-100">
                            ...
                            <div class="header-actions d-flex align-items-center">
                                    ...
                                    <?php if ($isLoggedIn): ?>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu">
                                                ...
                                                <?php 
                                                // Verificar si es admin de múltiples formas para asegurar compatibilidad
                                                $isAdmin = false;
                                                if (isset($currentUser['is_admin']) && $currentUser['is_admin']) {
                                                    $isAdmin = true;
                                                } elseif (isset($currentUser['role']) && $currentUser['role'] === 'administrador') {
                                                    $isAdmin = true;
                                                } elseif (isset($_SESSION['role']) && $_SESSION['role'] === 'administrador') {
                                                    $isAdmin = true;
                                                }
                                                
                                                if ($isAdmin): 
                                                ?>
                                                    <li><a class="dropdown-item" href="/admin/index.php"><i class="fas fa-tachometer-alt me-2"></i>Panel Admin</a></li>
                                                <?php endif; ?>
                                ...
                                <div class="currency-selector me-2">
                                    <div class="btn header-btn d-flex align-items-center">
                                        <span class="currency-option" id="ars-option" onclick="setCurrency('ARS')" style="cursor: pointer; padding: 0 8px; font-weight: bold;">ARS</span>
                                        <span style="color: #fff; padding: 0 5px;">-</span>
                                        <span class="currency-option" id="usd-option" onclick="setCurrency('USD')" style="cursor: pointer; padding: 0 8px;">USD</span>
                                    </div>
                                </div>
                            ...
                            <li class="nav-item dropdown position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-large">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h6 class="dropdown-header">Modernas</h6>
                                            ...
                                            <div class="col-md-4">
                                                <h6 class="dropdown-header">Clásicas</h6>
                                            ...
                                            <div class="col-md-4">
                                                <h6 class="dropdown-header">Retro & Otros</h6>
                        ...
                        <div class="nav-search-section">
                            <form class="search-form" action="/productos.php" method="GET">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control search-input" placeholder="Buscar productos...">
