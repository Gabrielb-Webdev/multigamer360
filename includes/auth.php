...
function getCurrentUser() {
    ...
    if (isset($_SESSION['user_complete_data'])) {
        // Asegurar que is_admin esté presente si el rol es administrador
        if (!isset($_SESSION['user_complete_data']['is_admin']) && 
            isset($_SESSION['user_complete_data']['role']) && 
            $_SESSION['user_complete_data']['role'] === 'administrador') {
            $_SESSION['user_complete_data']['is_admin'] = 1;
        }
